...
public class ProdutoController {
		...
		private static final String LISTAR_PRODUTOS = "listarProduto.jsp";
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			if (acao.equalsIgnoreCase("criar")) {
				...
				List<Produto> listaProduto = produtoDAO.findAllProduto();
				request.setAttribute("listaProduto", listaProduto);
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			// Se o id_produto e vazio, criamos. Senao, atualizamos uma produto existente
